...
@dataclass
class VideoUnirelightCondition(BaseVideoCondition):
...
class VideoUnirelightConditioner(GeneralConditioner):
    def forward(
        self,
        batch: Dict,
        override_dropout_rate: Optional[Dict[str, float]] = None,
    ) -> VideoUnirelightCondition:
        output = super()._forward(batch, override_dropout_rate)
        return VideoUnirelightCondition(**output)