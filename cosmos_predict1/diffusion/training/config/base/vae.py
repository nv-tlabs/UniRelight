...
from cosmos_predict1.diffusion.training.module.pretrained_vae import VideoJITTokenizer, JITVAE, JointImageVideoSharedJITTokenizer, VideoJITTokenizer
...
def get_cosmos_tokenizer_comp8x8x8(resolution: str, chunk_duration: int) -> omegaconf.dictconfig.DictConfig:
    ...
    return L(JointImageVideoSharedJITTokenizer)(
        ...
        image_vae=L(JITVAE)(
            ...
            enc_fp="checkpoints/Cosmos-Tokenize1-CV8x8x8-720p/encoder.jit",
            dec_fp="checkpoints/Cosmos-Tokenize1-CV8x8x8-720p/decoder.jit",
            mean_std_fp="checkpoints/Cosmos-Tokenize1-CV8x8x8-720p/image_mean_std.pt",
            latent_ch=16,
            is_image=False,
            is_bf16=True,
        ),
