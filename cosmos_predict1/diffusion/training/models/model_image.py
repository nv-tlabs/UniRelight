...
class DiffusionModel(Model):
    ...
    def compute_loss_with_epsilon_and_sigma(
        ...
        sigma: torch.Tensor,
        custom_loss_weights: Optional[torch.Tensor] = None, 
    ):
        """
        ...
        if custom_loss_weights is not None:
            pred_mse = pred_mse * custom_loss_weights
        # print('[DEBUG custom_loss_weights]', custom_loss_weights.shape, custom_loss_weights[:, :, :custom_loss_weights.shape[2] // 3 * 2].mean(), custom_loss_weights[:, :, custom_loss_weights.shape[2] // 3 * 2:].mean())
