...
class MultiviewGeneralDIT(GeneralDIT):
    ...
    def forward_before_blocks(
        ...
        **kwargs,
        ...
        del kwargs
        # print('[data_type]', data_type, '[isinstance(data_type, DataType)]', isinstance(data_type, DataType))
        # assert isinstance(
        #     data_type, DataType
        # ), f"Expected DataType, got {type(data_type)}. {data_type}, We need discuss this flag later."
