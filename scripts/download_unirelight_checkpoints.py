...
def parse_args():
    parser = argparse.ArgumentParser(description="Download NVIDIA Cosmos Predict1 UniRelight models from Hugging Face")
    parser.add_argument(
...
MD5_CHECKSUM_LOOKUP = {
    ...
    "UniRelight/model.pt": "92b0c36674e25c39a1cb59d06f67cafb",
}
